...
export const LS_KEYS = {
  ...
  deletedReviewKeys: `${STORAGE_PREFIX}deleted_review_keys`,
  syncDirtySessions: `${STORAGE_PREFIX}sync_dirty_sessions`,
  syncDirtyReviews: `${STORAGE_PREFIX}sync_dirty_reviews`,
  syncDirtyAppState: `${STORAGE_PREFIX}sync_dirty_app_state`,
  g1MigrateResult: `${STORAGE_PREFIX}g1_migrate_result`,
  g1MigrateBackup: `${STORAGE_PREFIX}g1_migrate_backup`,
...
export const APP_DATA_EXACT_KEYS: readonly string[] = [
  ...
  LS_KEYS.deletedReviewKeys,
  LS_KEYS.syncDirtySessions,
  LS_KEYS.syncDirtyReviews,
  LS_KEYS.syncDirtyAppState,
  LS_KEYS.g1MigrateResult,
  LS_KEYS.g1MigrateBackup,
  LS_KEYS.shopItems,
  LS_KEYS.activeEnt,
  LS_KEYS.routine,
