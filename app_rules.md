...
| 手動補番茄跨午夜 | `buildManualSession` 的時間輸入上限 23:59、無法跨午夜（#3b 只處理即時番茄 `confirmRating` 的自動切兩顆）；極少見故暫緩；觸發＝要手動補跨午夜番茄時，比照 confirmRating 拆兩顆邏輯。 |
...
*最後更新：2026/07/17（#3b 跨午夜番茄自動切兩顆：前段昨天到 24:00、後段今天從 00:00，金幣只發前段）*
